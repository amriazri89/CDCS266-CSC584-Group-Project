...
<body style="background-color:whitesmoke">
    ...
    <a href="listofjobvacancy.html" style="font-weight:10px;text-align:center;text-decoration: none;height:30px;margin-left: 20px;font: 1em sans-serif;border-radius: 5px;width:200px;">&nbsp;&nbsp;Back as Company Admin</a>
